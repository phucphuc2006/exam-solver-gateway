...
const WORKER_URL = process.env.TUNNEL_WORKER_URL || "https://ES Gateway.com";
const MACHINE_ID_SALT = "ES Gateway-tunnel-salt";
...
export async function enableTunnel(localPort = 20128) {
  ...
  const publicUrl = `https://r${shortId}.es-gateway.com`;
...
export async function getTunnelStatus() {
  ...
  const publicUrl = shortId ? `https://r${shortId}.es-gateway.com` : "";
