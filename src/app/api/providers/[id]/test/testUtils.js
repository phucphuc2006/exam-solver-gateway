...
// Safe fallbacks for removed providers
const QWEN_CONFIG = { tokenUrl: "", clientId: "" };
const CLAUDE_CONFIG = { tokenUrl: "", clientId: "" };
const CLINE_CONFIG = { refreshUrl: "" };
const KILOCODE_CONFIG = { apiBaseUrl: "" };
...
const OAUTH_TEST_CONFIG = {
  ...
  github: {
    ...
    authHeader: "Authorization",
    authPrefix: "Bearer ",
    extraHeaders: { "User-Agent": "ES Gateway", "Accept": "application/vnd.github+json" },
  },
  iflow: {
